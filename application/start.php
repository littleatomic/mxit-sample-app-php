...
/*
|--------------------------------------------------------------------------
| Auto-Loader of Procedural Functions
|--------------------------------------------------------------------------
|
| The Laravel auto-loader works well for classes, but not for procedural
| code such as the Mxit functions
|
*/

$directory = path('app').'helpers';

foreach ( new DirectoryIterator( $directory ) as $fileinfo )
{
    if ( $fileinfo->isFile() )
    {
        require_once $directory . DS . $fileinfo->getFilename();
    }
}
